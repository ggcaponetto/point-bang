// The editor's translations, moved VERBATIM from the old
// public/editor-i18n.js. Flat dotted keys and single-brace {param}
// placeholders on purpose — i18n.ts configures i18next to match, so every
// string survived the migration byte-for-byte (the parity test in
// test/i18n.test.ts pins the three catalogs to the same key set).
...
export const en: Record<string, string> = {
  ...
  "inspector.empty": "Tap a button on the canvas — or pick a slot above — to edit it.",
};
...
export const de: Record<string, string> = {
  ...
  "inspector.empty":
    "Tipp einen Button auf der Fläche an — oder wähle oben einen Platz — um ihn zu bearbeiten.",
};
...
export const it: Record<string, string> = {
  ...
  "inspector.empty": "Tocca un pulsante sull'area — o scegli uno slot qui sopra — per modificarlo.",
};
