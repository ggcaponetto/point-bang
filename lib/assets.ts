...
/** The buildless phone-page files — committed sources, published to Pages. */
export const PHONE_ASSETS = ["index.html", "math.js", "buttons.json", "transport.js"];

/**
 * Generated by the editor workspace (`npm run -w editor build`, a
 * vite-plugin-singlefile bundle) — never committed, never published to
 * Pages; the editor only works against the local PC server.
 */
const EDITOR_ASSETS = ["editor.html"];

/** Everything the server serves; also the SEA asset key list. */
export const PUBLIC_ASSETS = [...PHONE_ASSETS, ...EDITOR_ASSETS];
